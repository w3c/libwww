...
$ link /exe=[--.VAX.MULTINET]www.exe [--.VAX.MULTINET]HTBrowse.obj, [--.VAX.MULTINET]GridText.obj, [--.VAX.MULTINET]DefaultStyles.obj, [---.LIBRARY.VAX.MULTINET]wwwlib/lib, [---.LIBRARY.VAX.MULTINET]wwwlib.opt/opt
$ continue
$ continue
