...
!MESSAGE 
!MESSAGE NMAKE /f "wwwdir.mak" CFG="Win32 Debug"
!MESSAGE 
...
ALL : $(OUTDIR)/wwwdir.dll $(OUTDIR)/wwwdir.bsc
...
CPP_PROJ=/nologo /MT /W3 /GX /YX /O2 /D "NDEBUG" /D "WIN32" /D "_WINDOWS" /D\
 "WWW_WIN_DLL" /FR$(INTDIR)/ /Fp$(OUTDIR)/"wwwdir.pch" /Fo$(INTDIR)/ /c 
CPP_OBJS=.\WinRel/
...
$(OUTDIR)/wwwdir.bsc : $(OUTDIR)  $(BSC32_SBRS)
    $(BSC32) @<<
...
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib\
 ...
 /OUT:$(OUTDIR)/"wwwdir.dll" /IMPLIB:$(OUTDIR)/"wwwdir.lib" 
DEF_FILE=.\wwwdir.def
LINK32_OBJS= \
...
CPP_PROJ=/nologo /MT /W3 /GX /Zi /YX /Od /D "_DEBUG" /D "WIN32" /D "_WINDOWS"\
 /D "WWW_WIN_DLL" /FR$(INTDIR)/ /Fp$(OUTDIR)/"wwwdir.pch" /Fo$(INTDIR)/\
 /Fd$(OUTDIR)/"wwwdir.pdb" /c 
CPP_OBJS=.\WinDebug/
