...
!MESSAGE 
!MESSAGE NMAKE /f "wwwdll.mak" CFG="Win32 Debug"
!MESSAGE 
...
ALL : $(OUTDIR)/wwwdll.dll $(OUTDIR)/wwwdll.bsc
...
$(OUTDIR)/wwwdll.bsc : $(OUTDIR)  $(BSC32_SBRS)
    $(BSC32) @<<
...
LINK32_FLAGS=/NOLOGO /SUBSYSTEM:windows /DLL /INCREMENTAL:no\
 ...
 /OUT:$(OUTDIR)/"wwwdll.dll" /IMPLIB:$(OUTDIR)/"wwwdll.lib" 
DEF_FILE=.\wwwdll.def
LINK32_OBJS= \
	$(INTDIR)/windll.obj \
	$(INTDIR)/wwwdll.obj
