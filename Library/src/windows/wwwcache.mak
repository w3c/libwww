...
!MESSAGE 
!MESSAGE NMAKE /f "wwwcache.mak" CFG="Win32 Debug"
!MESSAGE 
...
ALL : $(OUTDIR)/wwwcache.dll $(OUTDIR)/wwwcache.bsc
...
CPP_PROJ=/nologo /MT /W3 /GX /YX /O2 /D "NDEBUG" /D "WIN32" /D "_WINDOWS" /D\
 "WWW_WIN_DLL" /FR$(INTDIR)/ /Fp$(OUTDIR)/"wwwcache.pch" /Fo$(INTDIR)/ /c 
CPP_OBJS=.\WinRel/
...
$(OUTDIR)/wwwcache.bsc : $(OUTDIR)  $(BSC32_SBRS)
    $(BSC32) @<<
...
CPP_PROJ=/nologo /MT /W3 /GX /Zi /YX /Od /D "_DEBUG" /D "WIN32" /D "_WINDOWS"\
 /D "WWW_WIN_DLL" /D "DEBUG" /FR$(INTDIR)/ /Fp$(OUTDIR)/"wwwcache.pch"\
 /Fo$(INTDIR)/ /Fd$(OUTDIR)/"wwwcache.pdb" /c 
CPP_OBJS=.\WinDebug/
