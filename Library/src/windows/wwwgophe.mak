...
!MESSAGE 
!MESSAGE NMAKE /f "wwwgophe.mak" CFG="Win32 Debug"
!MESSAGE 
...
ALL : $(OUTDIR)/wwwgophe.dll $(OUTDIR)/wwwgophe.bsc
...
CPP_PROJ=/nologo /MT /W3 /GX /YX /O2 /D "NDEBUG" /D "WIN32" /D "_WINDOWS" /D\
 "WWW_WIN_DLL" /FR$(INTDIR)/ /Fp$(OUTDIR)/"wwwgophe.pch" /Fo$(INTDIR)/ /c 
CPP_OBJS=.\WinRel/
...
$(OUTDIR)/wwwgophe.bsc : $(OUTDIR)  $(BSC32_SBRS)
    $(BSC32) @<<
...
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib\
 ...
 /OUT:$(OUTDIR)/"wwwgophe.dll" /IMPLIB:$(OUTDIR)/"wwwgophe.lib" 
DEF_FILE=.\wwwgophe.def
LINK32_OBJS= \
...
CPP_PROJ=/nologo /MT /W3 /GX /Zi /YX /Od /D "_DEBUG" /D "WIN32" /D "_WINDOWS"\
 /D "WWW_WIN_DLL" /FR$(INTDIR)/ /Fp$(OUTDIR)/"wwwgophe.pch" /Fo$(INTDIR)/\
 /Fd$(OUTDIR)/"wwwgophe.pdb" /c 
CPP_OBJS=.\WinDebug/
